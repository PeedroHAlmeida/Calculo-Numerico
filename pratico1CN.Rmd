...
# Considere q(x) = 816x^3 − 3835x^2 + 6000x − 3125 e p(x) = q(x + ω), onde ω é a
...
# # # (b) # # #
# Faça o gráfico de p(x) para (1,43 − ω) ≤ x ≤ (1,71 − ω). Mostre onde se 
...
# # # (c) # # #
# Começando com x0 = (1,5 − ω), o que o Método de Newton-Raphson faz?
...
# # # (d) # # #
# Começando com x0 = −ω e x1 = (1 − ω), o que o Método da Secante faz?
...
# # # (e) # # #
# Começando no intervalo [1 − ω, 2 − ω], o que o Método da Bissecçao faz?
